...
import cilok.com.lapakjahit.adapters.AdapterPP;
...
public class FragmentTransaksiPembelian extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecylerTransactionPembelian.setLayoutManager(new LinearLayoutManager(getActivity()));
        mAdapter = new AdapterPP(getActivity());
        mRecylerTransactionPembelian.setAdapter(mAdapter);
